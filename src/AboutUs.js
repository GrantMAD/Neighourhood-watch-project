           ...
           <div className="grid pt-20 md:pt-24 place-content-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
                <div className="pr-[25%] pl-[25%] w-full">
                    <h1 className="grid text-2xl place-content-center font-semibold underline underline-offset-8 decoration-1 mb-10 mt-10">Our Vision</h1>
                    ...
                    <h1 className="grid text-2xl place-content-center font-semibold underline underline-offset-8 decoration-1 mb-10">Our Mission</h1>
                    ...
                    <h1 className="grid text-2xl place-content-center font-semibold underline underline-offset-8 decoration-1 mb-10">Our Values</h1>
                    ...
                    <h1 className="grid text-2xl place-content-center font-semibold underline underline-offset-8 decoration-1 mb-10 mt-10">Our Objectives</h1>
