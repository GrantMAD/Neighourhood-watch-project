        ...
        <div class="bg-zinc-200 p-24">
            ...
            <div class="grid grid-cols-2">
                <div class="pr-[25%] pl-[25%] w-full">
                    <h1 class="grid text-2xl place-content-center font-semibold underline underline-offset-8 decoration-1 mb-10 mt-10">Our Vision</h1>
                    ...
                    <h1 class="grid text-2xl place-content-center font-semibold underline underline-offset-8 decoration-1 mb-10">Our Mission</h1>
                    ...
                    <h1 class="grid text-2xl place-content-center font-semibold underline underline-offset-8 decoration-1 mb-10">Our Values</h1>
