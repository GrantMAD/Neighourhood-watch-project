...
const ArchivedReports = (props) => {
    ...
    return (
        <main className="flex flex-col bg-zinc-200 min-h-screen">
            <div className="pt-24">
                <h1 className="grid text-4xl place-content-center font-semibold underline underline-offset-8 decoration-2 decoration-gray-800 mb-10 text-gray-800 text-center">Archived Incident Report's</h1>
            </div>
