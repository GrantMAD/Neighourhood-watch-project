            ...
            <div className="flex-grow pt-10 pb-10 lg:pr-60 lg:pl-60 md:pr-20 md:pl-20 sm:pr-10 sm:pl-10 bg-zinc-200">
                <div className="flex flex-col mt-10 mb-10 p-10 text-zinc-200 rounded-md shadow-lg shadow-gray-500 bg-gray-800">
                    <div className="flex justify-center mb-5">
                        <h1 className="text-5xl mb-5 font-semibold text-zinc-200 underline underline-offset-4 decoration-2 decoration-blue-600 md:text-center text-center">Neighbourhood Watch App</h1>
                    </div>
                    <div>
                        <img
                        ...
                        />
                        <div>
                        <p className="text-zinc-200 ">Introducing "The Neighbourhood Watch App" – your community's ultimate companion for safety, awareness, and unity, currently in beta. This user-friendly and innovative application empowers residents to come together and actively participate in safeguarding their neighborhood.</p>
                        ...
                        <p className="text-zinc-200 mt-3">The gallery feature allows users to share and appreciate neighborhood highlights, promoting a sense of pride and camaraderie within the community. From breathtaking scenery to exciting local events, the gallery showcases the best moments that bring neighbors together.</p>
                        ...
                        <p className="text-zinc-200 mt-3">The "check-in" and "check-out" system enhances the app's functionality, allowing members to log their presence during neighborhood patrols or events. This feature helps coordinate efforts, ensuring that no corner of the community is overlooked and that everyone feels secure and protected.</p>
                        <p className="text-zinc-200 mt-3">The members' page serves as a comprehensive directory, displaying essential details about each member within their sector. Easily connect with neighbors, foster friendships, and build a network of support in times of need.</p>
                        <p className="text-zinc-200 mt-3">The Neighbourhood Watch App redefines community engagement, transforming neighbors into active guardians of their shared spaces. Together, we build a stronger, safer, and more tightly-knit community, making our neighborhood a place we are proud to call home. Join us today and be a part of this transformative movement.</p>
                        </div>    
                    </div>
