            ...
            <div className="flex-grow pt-10 pb-10 lg:pr-60 lg:pl-60 md:pr-20 md:pl-20 sm:pr-10 sm:pl-10 bg-zinc-200">
                <div className="flex flex-col mt-10 mb-10 p-10 text-zinc-200 rounded-md shadow-lg shadow-gray-500 bg-gray-800">
                    ...
                    <div>
                        ...
                        />
                        <div>
                        <p className="text-zinc-200 ">Introducing "The Neighbourhood Watch App" – your community's ultimate companion for safety, awareness, and unity. This user-friendly and innovative application empowers residents to come together and actively participate in safeguarding their neighborhood.</p>
