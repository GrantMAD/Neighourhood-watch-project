    ...
    <div className="flex-container flex flex-col min-h-screen">
      ...
      <div className="flex flex-col mt-10 mb-10 p-10 text-zinc-200 rounded-md shadow-lg shadow-gray-500 bg-gray-800">
        <div className="flex justify-center">
          <h1 className="text-5xl mb-5 font-semibold text-zinc-200 underline underline-offset-8 decoration-2 decoration-blue-700">{story.storyTitle}</h1>
        </div>
        <div className="flex justify-center">
        ...
        <div>
        <img
            className="lg:h-2/5 lg:w-2/5 mt-2 mb-5 rounded-md ml-5 hover:scale-150 border-2 border-zinc-200 float-right"
            alt=""
            src={story.image}
          />
