...
const ContactPage = () => {
    ...
    return (
      <div class="h-screen bg-zinc-200 flex min-h-screen items-center justify-start">
        <div class="mx-auto w-full max-w-lg">
          <h1 class="text-4xl font-medium">Contact us</h1>
          <p class="mt-3"><a class="font-bold" href="mailto:Charlies.Coedmore@gmail.com">Email us </a> or message us here:</p>
          ...
          <form action="https://api.web3forms.com/submit" class="mt-10">
            ...
            <button type="submit" class="mt-5 rounded-md bg-black px-10 py-2 text-white shadow-xl">Send Message</button>
          </form>
        </div>
      </div>
    )
